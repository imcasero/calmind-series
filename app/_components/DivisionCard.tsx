  ...
  return (
    ...
    `}>
      ...
      <div className="p-6">
        ...
        `}>
          <div>
            <div className={`${config.statLabel} text-xs uppercase tracking-wide mb-1`}>Tipo</div>
            <div className="text-white font-bold">{variant === "gold" ? "Competitivo" : "Ascenso"}</div>
          </div>
          <div>
            <div className={`${config.statLabel} text-xs uppercase tracking-wide mb-1`}>Nivel</div>
            <div className="text-white font-bold">{variant === "gold" ? "Elite" : "Intermedio"}</div>
          </div>
        </div>
