...
export default function FinalError({ error, reset }: ErrorProps) {
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="retro-border border-4 border-retro-gold-500 bg-jacksons-purple-800 p-6 xs:p-8 max-w-md text-center">
        <div className="text-4xl mb-4">
          <span role="img" aria-label="error">
            👑
          </span>
        </div>
        <h1 className="pokemon-title text-retro-gold-400 text-lg xs:text-xl mb-4">
          Error en The Finals
        </h1>
